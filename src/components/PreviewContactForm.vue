		...
		<v-card width="530">
			...
			<v-card-text>
				...
				<v-row>
					...
					<v-col>
						<v-text-field
							:model-value="document.dateOfBirth?.format('DD / MM / YYYY')"
				...
				<v-textarea
					:model-value="document.additionalInfo"
					variant="outlined"
